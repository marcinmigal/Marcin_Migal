...
class Library:
    ...
    def __str__(self) -> str:
        return f'Biblioteka w {self.city} na ulicy {self.street}\
             o kodzie pocztowym {self.zip_code} otwarta w godzinach\
                  {self.open_hours}, nr telefonu: {self.phone}'
...
class Employee:
    ...
    def __str__(self) -> str:
        return f'Pracownik {self.first_name} {self.last_name} zatrudniony\
             {self.hire_date}, mieszkający w mieście: {self.city}\
                  {self.zip_code}, numer kontaktowy: {self.phone} '
...
class Book:
    ...
    def __str__(self) -> str:
        return f'Kaiążka wydana w {self.publication_date}, napisana przez\
             {self.author_name} {self.author_surname}, liczy\
                 {self.number_of_pages}\
                    stron, dostępna w bilbliotece: {self.library}'


class Order:

    def __init__(self, employee: Employee, student: Student,
                 books: Book, order_date: str):
    ...
    def __str__(self) -> str:
        return f'Książka wypożyczona przez {self.student.name}\
             w dniu {self.order_date}, przekazana przez \
...
employee_1 = Employee('Jan', 'Kowalski', '12-12-2019',
                      '10-07-1992', 'Rybnik', 'Prosta 11', '44-200', 502678543)
employee_2 = Employee('Adam', 'Nowak', '12-12-2019', '09-11-1986',
                      'Katowice', 'Warszawska 43/4', '44-007', 506786456)
employee_3 = Employee(
    'Jan',
    'Kowalski',
    '12-12-2019',
